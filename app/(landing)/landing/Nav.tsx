      ...
      <nav className="nav">
        ...
        <div className="md:hidden lg:flex flex-row justify-between gap-30 items-center">
          ...
          <div className="flex flex-row gap-20">
            <button className="text-xl cursor-pointer">Contact Us</button>
            <button
       ...
       {/* mobile nav */}
        ...
        <div className={` fixed inset-0 z-50 flex-col bg-black/50 backdrop-blur-2xl transition-transform duration-300 ${open ? "translate-x-0" : "translate-x-full" }`}>
